...
#warning 调用
                ...
                UIColor *buttonTitleColor=view.button.titleLabel.textColor;
                view.button.layer.borderColor = buttonTitleColor.CGColor;
                view.button.layer.cornerRadius=6.0;
                view.button.clipsToBounds=YES;
...
#warning 全局修改宽度
            ...
            [metrics setValue:@(padding) forKey:@"padding"];
